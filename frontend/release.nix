...
let
  ...
  my-openresty-bin-sh = nPkgs.writeShellApplication {
    ...
    text = ''
      ...
      [ ! -d ${my-openresty-config.api-gw.uploadHome}/dumpfiles ] && mkdir -p ${my-openresty-config.api-gw.uploadHome}/dumpfiles && chown -R nobody:nogroup ${my-openresty-config.api-gw.uploadHome}/dumpfiles
      [ ! -d ${my-openresty-config.api-gw.uploadHome}/parsereports ] && mkdir -p ${my-openresty-config.api-gw.uploadHome}/parsereports && chown -R nobody:nogroup ${my-openresty-config.api-gw.uploadHome}/parsereports
