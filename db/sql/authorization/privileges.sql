...
grant usage on schema data to :"authenticator";
grant select, insert, update, delete on data.jobs to :"authenticator";
...
grant execute on function api.submit_parsedump_job(text,json) to webuser;
grant execute on function api.update_parse_report(integer,json) to webuser;


-- give access to the view owner to this table
grant select, insert, update, delete on data.jobs to api;
grant usage on data.jobs_id_seq to webuser;
...
grant select, insert, update, delete on api.jobs to webuser;

-- anonymous users can only request specific columns from this view
-- grant select (id, jobs) on api.jobs to anonymous;

-- give access to the view owner to this table
grant select, insert, update, delete on data.user_jobs_rel to api;
grant usage on data.user_jobs_rel_id_seq to webuser;
